          ...
          objectStore.openCursor().onsuccess = function(e) {
               ...
               if(cursor) {
                    ...
                    ConsultationHTML.innerHTML = `  
                         <p class="font-weight-bold">Name:  <span class="font-weight-normal">${cursor.value.patientname}<span></p>
                         ...
                         <p class="font-weight-bold">Problem:  <span class="font-weight-normal">${cursor.value.symptoms}<span></p>
                    `;
                 ...
                 consultations.appendChild(ConsultationHTML);
                   ...
                   services.textContent = 'Check Your Schedule'
